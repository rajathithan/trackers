# *****************************************************************************
# Detection and tracking - Hough circles and GOTURN tracker
...
videoFileName = "football.mp4"
cap = cv2.VideoCapture(videoFileName)

# Set the width and height parameters for output video
width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
out = cv2.VideoWriter('Track-the-football.mp4',cv2.VideoWriter_fourcc(*'MP4V'), 20, (width,height))
...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        circles = cv2.HoughCircles(img_blur, cv2.HOUGH_GRADIENT, 1, 450, param1=300, param2=8, minRadius=19, maxRadius=23)
        ...
        if circles is not None:
            ...
            for i in circles[0, :]: 
                ...
                # Here I am selecting only the circles above 420 px in the y axis            
                if i[1] > 420:
